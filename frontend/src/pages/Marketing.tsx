  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="max-w-5xl mx-auto px-6 py-10 flex items-center justify-between">
        <div className="text-xl font-semibold">Cozy Corner Dates</div>
      ...
      <main className="max-w-5xl mx-auto px-6 pb-20">
        <section className="grid gap-10 md:grid-cols-2 items-center">
          <div className="space-y-5">
            <p className="text-sm font-medium text-primary">Save better date ideas</p>
            <h1 className="text-4xl md:text-5xl font-display font-semibold">
              Turn moments into memorable date plans.
            </h1>
            <p className="text-muted-foreground text-lg">
              Capture date ideas from anywhere, organize them by location,
              and share with your favorite person. No more lost screenshots.
            </p>
            <div className="flex items-center gap-3">
              <Button asChild>
